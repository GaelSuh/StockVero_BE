...
export const listSuperAdmins = async (req: AdminRequest, res: Response) => {
  try {
...
export const createSuperAdmin = async (req: AdminRequest, res: Response) => {
  try {
...
export const changeSuperAdminPassword = async (req: AdminRequest, res: Response) => {
  try {
