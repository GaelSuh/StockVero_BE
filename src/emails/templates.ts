...
function baseTemplate(title: string, body: string, buttonUrl?: string, buttonText?: string): string {
...
function monospaceBox(content: string): string {
  return `
...
export function tenantRegistrationReceived(params: { ownerName: string; orgName: string }): string {
...
export function tenantApproved(params: { ownerName: string; orgName: string; loginUrl: string }): string {
...
export function tenantDenied(params: { ownerName: string; orgName: string; reason: string }): string {
...
export function tenantSuspended(params: { ownerName: string; orgName: string; reason: string }): string {
  const { ownerName, orgName, reason } = params;
...
export function employeeWelcome(params: { employeeName: string; orgName: string; email: string; temporaryPassword: string; loginUrl: string }): string {
...
export function employeePasswordReset(params: { employeeName: string; temporaryPassword: string }): string {
...
export function forgotPassword(params: { name: string; otpCode: string }): string {
...
export function emailVerification(params: { name: string; otpCode: string }): string {
  const { name, otpCode } = params;
...
export function trialEndingWarning(params: { ownerName: string; orgName: string; trialEndsAt: string; billingAmount: string; billingCycle: string; billingUrl: string }): string {
...
export function paymentSuccessful(params: { ownerName: string; orgName: string; amount: string; billingCycle: string; nextBillingDate: string }): string {
...
export function paymentFailed(params: { ownerName: string; orgName: string; amount: string; reason: string; billingUrl: string }): string {
...
export function subscriptionCancelled(params: { ownerName: string; orgName: string; accessEndsAt: string }): string {
