 ...
 */
export async function computeDailySummary(tenantId, date, mode) {
    ...
    const totalCollected = cashTotal + mobileMoneyTotal + cardTotal + bankTransferTotal + otherTotal;
    return {
 ...
 */
export async function generateDailySummary(tenantId, date, mode) {
 ...
 * the next sale lands.
 */
export async function getDailySummary(tenantId, date, mode) {
