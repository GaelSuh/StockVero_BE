...
export async function getCreditCustomers(tenantId) {
 ...
 */
export async function getCustomerPurchaseHistory(tenantId, customerId) {
    const sales = await prisma.sale.findMany({
...
export async function getCustomerCreditSales(tenantId, customerId) {
