...
export async function recordSaleAsIncome(tx, sale, tenantId) {
 ...
 * into the sale total.
 */
export async function recordSaleTipAsIncome(tx, sale, tipAmount, tenantId) {
    if (tipAmount <= 0)
        return;
...
export async function recordReturnAsExpense(tx, saleReturn, saleNumber, tenantId) {
