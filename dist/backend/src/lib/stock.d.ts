...
export declare const isQuantityTracked: (category: StockCarrier) => boolean;
/**
 ...
 */
export declare const getAvailableStock: (category: StockCarrier, availableUnits: number, variant?: VariantStockCarrier | null) => number;
export declare const resolveStockStatus: (availableCount: number, reorderThreshold: number) => "OUT_OF_STOCK" | "LOW_STOCK" | "IN_STOCK";
